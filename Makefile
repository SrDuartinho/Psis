...
universe-server: proto/messages.pb.cc universe-server.c universe-data.o communication_proto.cpp communication.h gravitation.c gravitation.h display.c display.h
	$(CC) $(CFLAGS) -o universe-server universe-server.c communication_proto.cpp proto/messages.pb.cc gravitation.c display.c universe-data.o \
